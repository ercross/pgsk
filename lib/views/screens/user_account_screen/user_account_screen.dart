...
class UserAccountPage extends StatelessWidget {
  ...
  final List<Product> staticProducts = [
    Product(
        ...
        description: "",
        category:
            ProductCategory(id: 1.toString(), name: "Antivirus Protection"),
    ...
    Product(
        ...
        description: "",
        category:
            ProductCategory(id: 2.toString(), name: "Internet Protection"),
    ...
    Product(
        ...
        description: "",
        category:
            ProductCategory(id: 3.toString(), name: "Antivirus Protection"),
