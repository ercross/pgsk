  ...
  Widget _buildPrimaryInfo() => Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                  "\n${PGSK.currency}${widget.product.price.toStringAsFixed(0)}",
  ...
  Widget _buildSecondInfoTab() {
    return Column(
      ...
      children: [
        ...
        _buildReviewRating(),
        Text(
            "Kaspersky Antivirus  is the awarded protection against viruses, spyware, and other malware"),
        SizedBox(height: 10),
