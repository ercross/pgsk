  ...
  Widget _buildASearchSuggestion(String suggestion) {
    return Container(
      ...
      child: Text(suggestion, 
        ...
        style: Theme.of(ctx).textTheme.caption.copyWith(fontWeight: FontWeight.w500))
    );
  }
//
  Widget _buildSearchSuggestions(List<String> searchSuggestions, BoxConstraints size) {
                  ...
                  child: Form(
                    child: TextFormField(
                      decoration: InputDecoration( 
                        ...
                        labelStyle: Theme.of(ctx).textTheme.subtitle2.copyWith(fontSize: 12)
                      )
                    ),
                  )
                )
      ...
      child: SizedBox (
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(child: _buildSearchSuggestions(searchSuggestions, size),)
          ],
        )
      )
    );
      ...
      body: LayoutBuilder(
        builder: (ctx, constraints) {
          return Column(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              CustomAppBar(size: constraints, title: "Search", trailing: _buildFilterButton()),
              SizedBox(height: 15,),
